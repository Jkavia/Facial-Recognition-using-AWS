...
exports.handler = (event, context, callback) => {
    ...
    //Configuration - Start
    var srcBucket = 'detect-face-for-ad-janardan';
    var managerPhoneNumber = "+12028768349";
            ...
            if (result !== null) {
                ...
                if (err) {
                    ...
                    if (result.FaceDetails !== null && result.FaceDetails.length > 0) { 
                        //parsing the response of detectfaces API    
                        var item = result.FaceDetails[0];
                            //more than 80% confident if its a human only then proceed
